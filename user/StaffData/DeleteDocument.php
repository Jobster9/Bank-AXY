<?php include "header.php";
    ...
    include("DeleteDocumentDetails.php");
        ...
        <div class="row">
            <div class="col-md-12 mt-lg-4 mt-4">
                ...
                <div class="d-sm-flex align-items-center mb-4" style="justify-content:center;">
                    <h1 class="h3 mb-0 light" style="text-align: center;">Confirm Deletion of: <?php echo $rows_array[0]["Document_Name"] ?></h1>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <h3 class="h3 mb-4 light" style="text-align: center;">Document ID: <?php echo $rows_array[0]["Document_ID"] ?></h3> 
    <p style="text-align: center;"> Please confirm you want to delete & archive this document.</p>

                                        <form method="post">
                   <small><h3 class="h3 mb-0 light" style="text-align: center;">Document Name: <?php echo $rows_array[0]["Document_Name"] ?></h3><small> 
                   <small><h3 class="h3 mb-0 light" style="text-align: center;">Document Type: <?php echo $rows_array[0]["Document_Type"] ?></h3><small> 
                   <small><h3 class="h3 mb-0 light" style="text-align: center;">Document Criticality: <?php echo $rows_array[0]["Document_Criticality"] ?></h3><small> 
                                    ...
                                    <div id="backButton" class="d-grid col-sm-6 mx-auto">
                                        <button onclick="document.location='ViewDocuments.php'" style="margin-top: 20%; margin-bottom: 25%;" class="btn btn-lg btn-block">Go Back</button>
...
if (isset($_POST['submit'])) {
    $result = deleteDocument($Document_ID);
...
function deleteDocument($Document_ID)
{
    // Create a new PDO connection object
    include("../../DB config.php");
    $stmt = $pdo->prepare("DELETE FROM dbo.Documents WHERE Document_ID = ?");
