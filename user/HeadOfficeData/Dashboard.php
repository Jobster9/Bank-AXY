            ...
            <div class="col-md-12 mt-lg-4 mt-4">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-4 ">Number of Inactive Admins in your Branch</h5>
...
<script src="https://canvasjs.com/assets/script/canvasjs.min.js"></script>
  <script>
        var low = <?php echo $lowdocuments1; ?>;
        var medium = <?php echo $lowdocuments; ?>;
    ...
    dataPoints: [
      { y: low, label: "Kuching", color: "#010066" },
      { y: medium, label: "Kuala Lumpur", color: "#FFCC00" },
    ]
